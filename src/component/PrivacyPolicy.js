    ...
    <>
       <div className="policy-container">
        ...
        <p className="Policy-text">
          ...
          put your trust in us when you provide us with your information and we
          do not take this lightly. <br /> We strive to be transparent in the
          way we process your data. We actually want you to read our policies
          and understand our privacy practices.{" "}
        </p>
        <h2 className="policy-heading">PRIVACY POLICY</h2>
        <p className="Policy-text">
          Welcome to Playdates’s Privacy Policy. Thank you for taking the time
          to read it. <br /> We appreciate that you trust us with your
          information and we intend to always keep that trust. <br /> This
          starts with making sure you understand the information we collect, why
          we collect it, how it is used and your choices regarding your
          information. This Policy describes our privacy as simply as possible.{" "}
        </p>
        ...
        <p className="Policy-text">
          ...
          when you access our services through a social media account. If you
        ...
        <ul>
          ...
          <li>
            ...
            you may allow us to access your camera or photo album. Some of the
            information you choose to provide us may be considered “special” or
            “sensitive” in certain jurisdictions, for example your racial or
            ethnic origins, sexual orientation and religious beliefs. By
            choosing to provide this information, you consent to our processing
            of that information.
          </li>
          <li>
          ...
          <li>
            ...
            you give us during the interaction. Sometimes, we monitor or record
            these interactions for training purposes and to ensure a high
            quality of service.
          </li>
          <li>
            ...
            others that you give us in order to complete your request.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            Social Media - You may be able to use your social media account
            (such as Facebook Login) to create and log into your Playdates
            account. This saves you from having to remember yet another user
            name and password and allows you to share some information from your
            social media account with us.
          </li>
          <li>
            Other Partners - We may receive info about you from our partners,
            for instance where Playdates ads are published on a partner’s
        ...
        <ul>
          <li>
            ...
            logged in, features you’ve been using, searches or search
            parameters, clicks and pages which have been shown to you, referring
            webpage address, advertising that you click on) and how you interact
            with other users (e.g., users you connect and interact with, time
            and date of your exchanges, number of messages you send and
            receive).
          </li>
          <li>
            ...
            <ul>
              <li>
                ...
                app crashes, advertising IDs (such as Google’s AAID and Apple's
                IDFA, both of which are randomly generated numbers that you can
                reset by going into your device’ settings), browser type,
                ...
                identify your device or browser (e.g., IMEI/UDID and MAC
                address); and
              </li>
              <li>
        ...
        <p className="Policy-text">
          ...
          <br /> Some web browsers (including Safari, Internet Explorer, Firefox
          and Chrome) have a “Do Not Track” (“DNT”) feature that tells a website
        ...
        <p className="Policy-text">To help you connect with other users</p>
        <ul>
          <li>
        ...
        <p className="Policy-text">To serve you relevant offers and ads</p>
        <ul>
        ...
        <p className="Policy-text">To ensure legal compliance</p>
        <ul>
        ...
        <ul>
          <li>
            ...
            For instance, as you go about using our service to experience
            different interactions, we use your information to maintain your
        ...
        <p className="Policy-text">
          ...
          your privacy settings. We also share some users’ information with
          service providers and partners who assist us in operating the
          services, and, in some cases, legal authorities. Read on for more
        ...
        <p className="Policy-text">
          ...
          you’re comfortable being publicly viewable since neither you nor we
          can control what others do with your information once you share it.
        </p>
        <p className="Policy-text">
        ...
        <p className="Policy-text">
          ...
          advertising, payment processing and security operations. <br /> We may
          also share information with partners who distribute and assist us in
        ...
        <p className="Policy-text">
          ...
          the information. <br /> We may use and share non-personal information
          ...
          circumstances. We may also share this information with third parties
          (notably advertisers) to develop and deliver targeted advertising on
          our services and on websites or applications of third parties, and to
        ...
        <p className="Policy-text">
          ...
          allows for users to be located in the European Economic Area (“EEA”),
          their personal information is transferred to countries outside of the
          EEA. We use standard contract clauses approved by the European
          Commission or other suitable safeguard to permit data transfers from
        ...
        <ul>
          ...
          <li>
            ...
            specific types of device data and notifications, such as phone book
            and location services as well as push notifications. You can change
            your settings on your device to either consent or oppose the
            collection of the corresponding information or the display of the
        ...
        <ul>
          <li>
            Reviewing your information. Applicable privacy laws may give you the
            right to review the personal information we keep about you
            (depending on the jurisdiction, this may be called right of access,
            right of portability or variations of those terms). You can request
            a copy of your personal information by putting in such a request.{" "}
          </li>
          <li>
            Updating your information. If you believe that the information we
            hold about you is inaccurate or that we are no longer entitled to
            use it and want to request its rectification, deletion or object to
            its processing, please contact us.{" "}
          </li>
        </ul>
        <p className="Policy-text">
        ...
        <p className="Policy-text">
          ...
          customers asking about the businesses’ practices related to disclosing
          personal information to third parties for the third parties’ direct
          marketing purposes. If you wish to find out about any rights you may
          have under California Civil Code section 1798.83, please contact us.{" "}
        </p>
        <p className="Policy-text">
          From time to time, as part of a joint promotion with a third party, we
          may, if you participate in such promotion, disclose your contact
          information to the third party to allow them to market their products
          or services to you. Where this is a condition for participation in a
        ...
        <p className="Policy-text">
          ...
          exercise choice regarding the collection of personal information of a
          consumer over time and across third party online services, to the
          ...
          online services to disclose whether third parties may collect personal
          information about their users’ online activities over time and across
          different online services when the users use the operator’s service.
          We do not knowingly permit third parties to collect personal
        ...
        <ul>
          ...
          <li>
            there is an outstanding or potential issue, claim or dispute
            requiring us to keep the relevant information until it is resolved;
            or
          </li>
          <li>
            the information is kept for our legitimate business interests, such
